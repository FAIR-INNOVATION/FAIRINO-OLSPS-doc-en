...
Figure 3-1 shows the welding preparation, where Figure 3-1a shows the workpiece to be welded and Figure 3-1b shows the robot and the workpiece.

.. figure:: quick_start/3-1a.png
	:align: center
	:width: 3in

.. centered:: Figure 3-1a  Workpiece to be Welded
 
.. figure:: quick_start/3-1b.png
	:align: center
	:width: 3in

.. centered:: Figure 3-1b  Robot + Workpiece   
.. centered:: Figure 3-1  Welding Preparation  

Equipment Installation
------------------------
The camera and torch are mounted on the end of the robot via connectors as shown in Figure 3-2.

.. figure:: quick_start/3-2.png
	:align: center
	:width: 3in

.. centered:: Figure 3-2  Mounting the Camera and Torch 
...
- Step5: Click the "Calculate" button in Figure 3-5 to calculate the tool coordinate system;

- Step6: If you need to reset, click the "Cancel" button in Figure 3-4 to calibrate the new tool coordinate system; if you don't need to reset, click "Save" in Figure 3-4 to store the tool coordinate system.

.. figure:: quick_start/3-5英文.png
	:align: center
	:width: 3in

.. centered:: Figure 3-5  Six-Point Method Tool Calibration Steps

Import Engineering
---------------------
Open the AIRLab software, click on the menu bar at the top of the interface, click the "File" button, click the "Open" button, select the project, click "Open" to import the project, as shown in Figure 3-6.

.. figure:: quick_start/3-6.png
	:align: center
	:width: 4in

.. centered:: Figure 3-6  Select Project Import
...
- Step1: Place the calibration plate directly below the camera, as shown in Figure 3-7. Switch the AIRLab main display box to the camera display, as shown in Figure 3-8;

.. figure:: quick_start/3-7.png
	:align: center
	:width: 4in

.. centered:: Figure 3-7  Placement of the calibration board

.. figure:: quick_start/3-8.png
	:align: center
	:width: 5in

.. centered:: Figure 3-8  AIRLab Software-Camera Display

- Step2: Click the sub-node of "Camera" in the engineering tree on the left side of AIRLab, the "Camera Properties" sub-page will be switched out on the right side, click the "Calibration Start" button, as shown in Figure 3-9. Click the "Auto Run" button in Figure 3-9, the camera will start to calibrate automatically, as shown in Figure 3-10, and the point cloud of AIRLab software is shown in Figure 3-11;

.. figure:: quick_start/3-9.png
	:align: center
	:width: 3in

.. centered:: Figure 3-9  Camera Properties-Calibration Begins

.. figure:: quick_start/3-10.png
	:align: center
	:width: 3in

.. centered:: Figure 3-10  Point cloud camera hand-eye calibration

.. figure:: quick_start/3-11.png
	:align: center
	:width: 7.5in

.. centered:: Figure 3-11  Point cloud calibration results
...
- Step1:Obtain the ground equations
  ...
  Click the "Workpiece Positioning" node in the project tree, the right sub-page of the software will be switched to "Workpiece Positioning Program", as shown in Figure 3-14. Click the "Shoot Ground" button, and then click "Save Ground" to save the calculated ground equations.

.. figure:: quick_start/3-14.png
	:align: center
	:width: 3in

.. centered:: Figure 3-14  Subpage - Workpiece Positioning Procedure
...
- Step3:Get the program configuration mode
  ...
  Read the program configuration mode set by the user, as shown in Figure 3-15, in which the manual debugging mode is used for single-step debugging; all identification after welding means that the robot will identify all the weld seams under the "template program" in the project tree and then carry out all the welding; single identification after welding means that the robot identifies only one weld seam at a time, and starts to weld that seam after the completion of the identification. Single identification and welding means that the robot only identifies one weld at a time, and when the identification is completed, it starts welding the weld, and when the welding is completed, it identifies the next weld, and then welds it again, until it completes the welding of all the welds under the "template program". Program arc start settings in the "not arc" is used for testing, users can choose "not arc" first simulation welding, simulation welding results are correct and then set "arc" for the actual welding. actual welding.

.. figure:: quick_start/3-15.png
	:align: center
	:width: 3in

.. centered:: Figure 3-15  Getting Program Configuration

- Step4:Weld seam identification
 
  After determining the program configuration mode and arc starting mode, the robot will start weld identification according to the specific instructions of the weld program, and after successful identification, it will generate correction points under the "Robot" node of the engineering tree, and generate welding instructions required by the robot under the "Program" node, as shown in Figure 3-16 and 3-17. The welding instructions required by the robot will be generated under the "Program" node, as shown in Figures 3-16 and 3-17.

.. figure:: quick_start/3-16.png
	:align: center
	:width: 3in

.. centered:: Figure 3-16  Welded Seam Recognition Results-Added Correction Points

.. figure:: quick_start/3-17.png
	:align: center
	:width: 3in

.. centered:: Figure 3-17  Weld Recognition Result-New Program Instruction
